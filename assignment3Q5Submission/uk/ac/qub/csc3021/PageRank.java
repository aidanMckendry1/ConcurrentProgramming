...
public class PageRank {
	...
	while( iter < max_iter && delta > tol ) {
		...
		long tm_edgemap_start = System.nanoTime();

	    context.edgemap( matrix, PRrelax );
	    double tm_edgemap = (double)(System.nanoTime() - tm_edgemap_start) * 1e-9;
		tm_edgemap_total += tm_edgemap;
	    ...
	    */
		...
		System.err.println( "iteration " + iter + ": residual error="
				    ...
				    + "time spent in edgemap= " + tm_edgemap_total + " seconds");
	    tm_start = System.nanoTime();
	}
